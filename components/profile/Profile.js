...
export default function Profile() {
   ...
   return (
      <div className="container mx-auto flex flex-col">
        ...
        text-xl lg:text-3xl"
            >
               i don&#39;t know why i make this web(just for fun website),just
               in love with this character (Linda, from dreadout 2) she is my
               type, thank you for reading this article have a nice day.
            </p>

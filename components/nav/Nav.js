...
export default function Nav() {
   ...
   return (
      <div className="">
         <div className=" flex flex-col lg:flex-row relative w-full z-50 text-amber-100 p-5">
            <div className="flex items-center justify-between gap-2 lg:py-0">
               <div>
                  <a
                     href="#"
                     className="text-amber-100 font-semibold uppercase"
                  >
                     Farrel Januar
                  </a>
               </div>
               <div>
                  <button
                     ...
                     className="focus:outline-none text-amber-100 block lg:hidden"
                  >
                     <svg
